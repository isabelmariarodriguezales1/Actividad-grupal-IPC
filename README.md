...
## Participación de cada coautor
   ...
   - Júlia Francisco Rodon: Script Boxplot.R, figura Boxplot.png y contribuciones al README.md.
...
2. **Gráficos/**: Contiene los ***scripts* de análisis de cada gráfico**.
    ...
    - Boxplot: Contiene el código R (*Boxplot.R*) para el análisis exploratorio de la distribución de datos del nivel de glucosa en función del tratamiento recibido, por sexo.
...
3. **Figuras generadas/**: Contiene las figuras PNG de cada gráfico
    ...
    - Boxplot: Figura Boxplot PNG resultante (*Boxplot.PNG*)
